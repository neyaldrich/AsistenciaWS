...
class EnviarReporteOperador(APIView):
    ...
    def post(self, request):
        ...
        idOperadorReporte= json["idOperador"]
        ...
        asistencias = Asistencia.objects.filter(fecha__gte = fechaInicio).filter(fecha__lte = fechaFin).filter(idOperador = idOperadorReporte)
