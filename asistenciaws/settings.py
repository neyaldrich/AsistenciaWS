"""
Django settings for asistenciaws project.
...
ROOT_URLCONF = 'asistenciaws.urls'
...
WSGI_APPLICATION = 'asistenciaws.wsgi.application'
...
# Configuracion de SMTP para envio de emails
